...
int OrderedLinearSearch(int *,int *,int);
/*
...
int main()
{
	...
	printf("Please enter the data in sorted order : \n");
	...
	int result = OrderedLinearSearch(buffer,&block_size,number);
...
int OrderedLinearSearch(int *buf,int *size,int no_search)
{
	int icnt;
	int ret_bool;
